...
public class DisenoMenu {
    public static void showMenu() {
        while (true) {
            String option = JOptionPane.showInputDialog(null, "ESTUDIANTES DE DISEÑO\n"
            ...
            switch (option) {
                case "1":
                    JOptionPane.showMessageDialog(null, RegistrarPrestamo.registrarDiseno(MainMenu.registroList)); // Registrar préstamo de equipo
                    break;
                case "2":
